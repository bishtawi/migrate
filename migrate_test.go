...
import (
	dStub "github.com/bishtawi/migrate/v4/database/stub"
	"github.com/bishtawi/migrate/v4/source"
	sStub "github.com/bishtawi/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/bishtawi/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/bishtawi/migrate/v4/source/stub"`
